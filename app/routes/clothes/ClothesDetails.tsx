    ...
    <>
      ...
      <div className="block sm:hidden">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm font-semibold text-red-100 border border-pink-950 rounded-lg p-3 mb-4">
          <div className="border-gray-800 border-b pb-3">
            <span className="text-xs block ">Gender:</span>
            <span className={getGenderColor(item.specificData.gender)}>
              {item.specificData.gender}
            </span>
          </div>
          <div className="border-gray-800 border-b pb-3">
            <span className="text-xs block">Age Group:</span>
            <span>{item.specificData.ageGroup}</span>
          </div>
          <div className="border-gray-800 border-b pb-3">
            <span className="text-xs block">Material:</span>
            <span className="text-[0.7rem] break-words">
              {item.specificData.fabricMaterial}
            </span>
          </div>
          <div className="border-gray-800 border-b pb-3">
            <span className="text-xs block">Size:</span>
            <span>{item.specificData.size}</span>
          </div>
          <div className="col-span-2 pb">
            <span className="text-xs block">Brand:</span>
            <span className="text-xs">{item.specificData.brand}</span>
          </div>
        </div>
        ...
        <h1 className="text-3xl text-fuchsia-400 mb-4">${item.price}</h1>
